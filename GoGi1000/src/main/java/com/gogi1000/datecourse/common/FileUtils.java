...
public class FileUtils {
    ...
    public static DatecourseImage parseFileInfo(MultipartFile file, String attachPath) throws IOException {
        ...
        */
        ...
        datecourseImage.setImageNm(imageNm);
        datecourseImage.setImageOriginNm(imageOriginNm);
        datecourseImage.setImageExt(imageExt);
        datecourseImage.setImagePath(imagePath);
